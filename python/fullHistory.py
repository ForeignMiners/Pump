...
def minutes_of_new_data(symbol, kline_size, data, source):
    ...
    elif source == "binance": old = datetime.strptime('1 Jan 2010', '%d %b %Y')
...
def get_all_binance(symbol, kline_size, save = False):
    ...
    if oldest_point == datetime.strptime('12 Feb 2021', '%d %b %Y'): print('Downloading all available %s data for %s. Be patient..!' % (kline_size, symbol))
...
get_all_binance("MDABTC", "1h", save = True)
